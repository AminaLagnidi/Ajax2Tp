    ...
    <body>
        ...
        <div class="content">
            ...
            <%
                ...
                List<Machine> machinesToDisplay;

                if (m != null) {
                    machinesToDisplay = m.findAll();

                } else {
                    machinesToDisplay = new ArrayList<Machine>();
                }
            %>
            ...
            <fieldset>
                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        <%
                            for (Machine mm : machinesToDisplay) {
                        %>
                        <tr>
                            <td><%=mm.getId()%></td>
                            <td><%=mm.getReference()%></td>
                            <td><%=mm.getPrix()%></td>
                            <td><%= (mm.getMarque() != null) ? mm.getMarque().getLibelle() : "Null"%></td>
