...
<script>
    function showConfirmation2(marqueId) {
        var result = confirm("Êtes-vous sûr de vouloir supprimer cette marque ?");
        if (result) {
            // L'utilisateur a cliqué sur "OK", redirigez vers la servlet pour effectuer la suppression.
...
<script>
    function showConfirmation3(etudiantId) {
        var result = confirm("Êtes-vous sûr de vouloir supprimer cet etudiant ?");
        if (result) {
            // L'utilisateur a cliqué sur "OK", redirigez vers la servlet pour effectuer la suppression.
