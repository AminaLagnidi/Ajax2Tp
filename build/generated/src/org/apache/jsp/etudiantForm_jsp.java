...
public final class etudiantForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        var result = confirm(\"Êtes-vous sûr de vouloir supprimer cette marque ?\");\n");
      out.write("        if (result) {\n");
      out.write("            // L'utilisateur a cliqué sur \"OK\", redirigez vers la servlet pour effectuer la suppression.\n");
      ...
      out.write("</script>\n");
      out.write("<script>\n");
      out.write("    function showConfirmation3(etudiantId) {\n");
      out.write("        var result = confirm(\"Êtes-vous sûr de vouloir supprimer cet etudiant ?\");\n");
      out.write("        if (result) {\n");
      out.write("            // L'utilisateur a cliqué sur \"OK\", redirigez vers la servlet pour effectuer la suppression.\n");
      ...
      out.write("\n");
      out.write("<ul>\n");
      out.write("    <li><a class=\"active\" href=\"homeForm.jsp\">Home</a></li>\n");
      ...
      out.print(e.getSexe());
      out.write("</td>\n");
      out.write("                            <td><a class=\"bndelete\" href=\"#\" onclick=\"showConfirmation3(");
      out.print(e.getId());
